...
export class BasketballMatchEvent implements MatchEvent {
  public constructor(
  ...
  public getSummary(): MatchEventSummary {
    const name = NameUtils.getDashName(this.participant1, this.participant2);
